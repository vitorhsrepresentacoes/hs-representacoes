...
export function HermesLeadChat() {
  ...
  const [messages, setMessages] = useState<Message[]>([{ role: "assistant", content: "Posso buscar oportunidades B2C pelo HS Agent. Ex.: “Encontre pessoas em Sorocaba que pagam aluguel e demonstraram intenção de comprar um imóvel nos próximos 6 meses”." }]);
